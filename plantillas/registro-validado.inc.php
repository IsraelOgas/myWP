	<div class = "form-group">
		...
		<input type="text" class = "form-control" name = "nombre" placeholder = "Ej: Juan Perez" <?php $validador -> mostrarNombre()?>>
		<?php
	...
	<div class = "form-group">
		<label>Correo</label>
		<input type="text" class = "form-control" name = "correo" placeholder = "example@domain.com" <?php $validador -> mostrarCorreo()?>>
		<?php
			$validador -> mostrarErrorCorreo();
		?>
	</div>
	<div class = "form-group">
